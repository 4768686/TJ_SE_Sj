...
void stu_list::stu_list_1()/*合并，去重*/
{
	for (int i = 0; list_round_1[i].no > 0; i++) {/*第一轮*/
	...
	for (int i = 0; list_round_2[i].no > 0; i++) {/*第二轮*/
		for (int j = 0; j < MAX_STU_NUM; j++) {
...
int stu_list::print(const char* prompt)
{
	...
	for (int i = 0; list_merge[i].stu_no > 0; i++) {
		...
		if (list_merge[i].round_1 == 1 && list_merge[i].round_2 == 1)/*一、二轮都选*/
			cout << " Y      Y" << endl;
		else if (list_merge[i].round_1 == 0 && list_merge[i].round_2 == 1)/*一轮没选，二轮选了*/
			cout << " /      补选" << endl;
		else if (list_merge[i].round_1 == 1 && list_merge[i].round_2 == 0)/*一轮选了，二轮没选*/
			cout << " Y      退课" << endl;
	}
	cout << "============================================================" << endl;
	return 0;
